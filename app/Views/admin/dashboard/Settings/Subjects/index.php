...
<body class="sidebar-fixed">
                ...
                <div class="card">
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="input-field" id="inputField" style="display: none;">
                                <input type="text" name="subject_name" class="form-control subject" placeholder="Enter Subject" id="subject_name" required/>
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table id="subjectDatatables" class="table">
                        <thead>
                          <tr>
                            <th>Sr.No.</th>
                            <th>Subject Name</th>
    ...
    <script src="<?= base_url(); ?>/public/assets/js/subject.js"></script>
</body>
</html>