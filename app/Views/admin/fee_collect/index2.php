                      ...
                      <tbody>
                        ...
                        ?>
                          <?php foreach ($leads as $lead) : ?>
                            <tr>
                              <td><?= $i++ ?></td>
                              <td><a href="<?= base_url('admin/add_lead/' . $lead->id) ?>" style="color:black;"> <?= $lead->Name ?></a> </td>
                              <td><?= $lead->Email ?></td>
                              <td><?= $lead->Mob_1 ?></td>
                              <td><?= $lead->City ?></td>
                              <td><?= $lead->course ?></td>
          ...
          <div class="modal-body">
            ...
            <form class="forms-sample" id="new-lead-form">
              <div class="row">
                ...
                <div class="col-md-3 mt-2">
                  <div class="form-group">
                    <label for="">Source</label>
                      <select class="form-control" id="Source" name="Source" onchange="source(this.value)">
                        <option value="">Select</option>
                ...
                <div class="col-md-3 mt-2" id="other_sourse" style="display:none;">
                  <div class="form-group" >
                    <label for="">Other Source Description</label>
...
<script>
  ...
  function source(value){
    console.log(value);
    if(value ==5){
      document.getElementById('other_sourse').style.display = "block";
    }else{
      document.getElementById('other_sourse').style.display = "none";
    }  
  }
